...
\begin{table*}[t]
  \centering
      ...
      \begin{tabular}{ccccccccc} \\ \hline            
        \multicolumn{1}{|p{1.5cm}|}{\textbf{System}} 
            & \multicolumn{1}{|p{2cm}|}{\centering \textbf{Memory\\Interface}}
            & \multicolumn{1}{|p{2cm}|}{\centering \textbf{Interposition\\Layer}}
            & \multicolumn{1}{|p{1.5cm}|}{\centering \textbf{Trans-\\parent?}}
            & \multicolumn{1}{|p{1.5cm}|}{\centering \textbf{General?}}
            & \multicolumn{1}{|p{1.5cm}|}{\centering \textbf{What's\\Remote}}
            & \multicolumn{1}{|p{1.5cm}|}{\centering \textbf{Sharing\\support?}}
       \\ \hline
      ...
      \end{tabular}
    \vskip .5em
    \caption{Interfaces for remote memory adopted in some 
    recent systems \todo{is this table really adding any 
    value?}}
